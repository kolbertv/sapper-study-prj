<script context='module'>
  ...
  return this.fetch(`https://svelte-course-123.firebaseio.com/meetups/${meetupId}.json`)
      .then(res => {
        if (!res.ok) {
      ...
      .catch(err=>{this.error(404, 'code not fetch')})
  }
...
<section>
  ...
  <div class="content">
    ...
    <h2>{loadedMeetup.subtitle} - {loadedMeetup.adress}</h2>
